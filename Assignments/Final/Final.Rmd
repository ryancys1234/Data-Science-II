...
To answer my question using machine learning, I create bagging, random forest, and XGBoost models for each outcome and explore their variable importance metrics. To train the models and calculate their test MSEs, I split the data into 70% train and 30% test sets.

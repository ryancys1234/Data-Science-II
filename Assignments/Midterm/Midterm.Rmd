...
<style type="text/css"> .main-container {max-width: 75%; margin-left: auto; margin-right: auto;} </style>
...
state_coord <- read_csv("https://raw.githubusercontent.com/ryancys1234/Data-Science-II/main/Assignments/Midterm/state_coord.csv")
...
- The transformations do not yield significant changes in the relations between the variables. As such, the dependent variables are not transformed for the linear models, which we now turn our attention to.

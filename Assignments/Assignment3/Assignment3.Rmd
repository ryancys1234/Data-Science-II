...
```{r}
bind_rows(query$near_earth_objects$`2024-03-01`$close_approach_data)
query$near_earth_objects$`2024-03-01`

query %>% unnest(near_earth_objects)

%>% 
  select(estimated_diameter.meters.estimated_diameter_min,
